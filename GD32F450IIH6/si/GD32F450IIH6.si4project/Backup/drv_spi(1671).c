...
static struct ins_spi_configuration spi_cfg =
{
    ...
    .data_width = 8,
    .max_hz  = 20000000ul	/* ch378 max freq 30M(spi) */
};
...
uint8_t spi_xfer(struct gd32_spi_cs * gd32_spi_cs,
...
#if 0
uint8_t spi_xfer_send(struct gd32_spi_cs * gd32_spi_cs,
                       struct ins_spi_configuration* configuration, struct ins_spi_message* message)
{
	uint8_t data = 0xFF;
    /* take CS */
...
uint8_t spi_xfer_recv(struct gd32_spi_cs * gd32_spi_cs,
