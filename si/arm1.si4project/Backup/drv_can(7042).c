...
{
  // PCLK1 = HCLK / 4 = 30 M
  {1000UL * 1000, 	MK_BKCAN_BAUD(CAN_BT_SJW_2TQ, CAN_BT_BS1_7TQ,  CAN_BT_BS2_2TQ, 3)},
  {1000UL * 500,	MK_BKCAN_BAUD(CAN_BT_SJW_2TQ, CAN_BT_BS1_7TQ,  CAN_BT_BS2_2TQ, 6)},
  {1000UL * 250,	MK_BKCAN_BAUD(CAN_BT_SJW_2TQ, CAN_BT_BS1_9TQ,  CAN_BT_BS2_2TQ, 10)},
  {1000UL * 125,	MK_BKCAN_BAUD(CAN_BT_SJW_2TQ, CAN_BT_BS1_9TQ,  CAN_BT_BS2_2TQ, 20)},
  {1000UL * 100,	MK_BKCAN_BAUD(CAN_BT_SJW_2TQ, CAN_BT_BS1_7TQ,  CAN_BT_BS2_2TQ, 30)},
  {1000UL * 50,		MK_BKCAN_BAUD(CAN_BT_SJW_2TQ, CAN_BT_BS1_7TQ,  CAN_BT_BS2_2TQ, 60)},
  {1000UL * 20,		MK_BKCAN_BAUD(CAN_BT_SJW_2TQ, CAN_BT_BS1_12TQ, CAN_BT_BS2_2TQ, 100)},
  {1000UL * 10,		MK_BKCAN_BAUD(CAN_BT_SJW_2TQ, CAN_BT_BS1_12TQ, CAN_BT_BS2_2TQ, 200)}
};
...
static void bxcan1_hw_init(void)
{
  ...
  gpio_af_set(GPIOA, GPIO_AF_9, GPIO_PIN_12);
	...
	bxcan_init(CAN0, 500000ul, CAN_MODE_NORMAL);
  /* configure CAN0 NVIC */
...
static void bxcan2_hw_init(void)
{
  ...
  bxcan_init(CAN1, 500000ul, CAN_MODE_NORMAL);
...
static uint32_t bxcan_set_baud_rate(uint32_t can_periph, uint32_t baud)
{
  uint32_t mode;
