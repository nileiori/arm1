...
#define	Sensor_Scale 	65536
    ...
    while( 1 )
    {
        ...
        if((IMU_FRAME_HEADER_LSB == data_l) && (IMU_FRAME_HEADER_MSB == data_h))
        {
            ...
            if(sum == calSum)
            {
                memcpy((void*)&imu_info.syn_low, pData, sizeof(IMU_DATA_TypeDef));
                //送至上位机
                ...
                mixData.accelGrp[0] = (float)rs422_frame.data_stream.accelX * Accel_Scale / Sensor_Scale;
                ...
                mixData.accelGrp[1] = (float)rs422_frame.data_stream.accelX * Accel_Scale / Sensor_Scale;
                ...
                mixData.accelGrp[2] = (float)rs422_frame.data_stream.accelX * Accel_Scale / Sensor_Scale;
