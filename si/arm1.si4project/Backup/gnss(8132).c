...
{
	rs422->data_stream.latitude = hGPSBestPosData.latitude;
	rs422->data_stream.longitude = hGPSBestPosData.longitude;
	rs422->data_stream.altitude = hGPSBestPosData.height;
}
