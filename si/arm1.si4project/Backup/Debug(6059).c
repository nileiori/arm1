...
//	Oldman_i++;
	...
	if(++Oldman_i >= 5ul)
	{
		...
		Debug_Data.data1 = (short)(rs422->data_stream.gyroX)* Rate_Scale / Sensor_Scale;	//IMU
		Debug_Data.data2 = (short)(rs422->data_stream.gyroY)* Rate_Scale / Sensor_Scale;		
		Debug_Data.data3 = (short)(rs422->data_stream.gyroZ)* Rate_Scale / Sensor_Scale;			
