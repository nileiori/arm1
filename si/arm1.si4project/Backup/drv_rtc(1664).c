...
uint8_t rtc_gnss_adjust_time(void) 
{
    ...
    rtc_initpara.factor_asyn = prescaler_a;
    rtc_initpara.factor_syn = prescaler_s;
    rtc_initpara.year = ((pGnss->utc_year / 10) << 4) + pGnss->utc_year % 10;
    rtc_initpara.month = ((pGnss->utc_month / 10) << 4) + pGnss->utc_month % 10;
    rtc_initpara.date = ((pGnss->utc_day / 10) << 4) + pGnss->utc_day % 10;
    rtc_initpara.hour   = ((pGnss->utc_hour / 10) << 4) + pGnss->utc_hour % 10;
    rtc_initpara.minute = ((pGnss->utc_min / 10) << 4) + pGnss->utc_min % 10;;
    rtc_initpara.second = ((pGnss->utc_sec / 10) << 4) + pGnss->utc_sec % 10;;
