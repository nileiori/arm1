...
{
#define	Accel_Scale 	12.0
#define	Rate_Scale 		300.0
#define	Angle_Scale 	360.0
#define	Temp_Scale		200.0
#define	Sensor_Scale 	32768.0
	...
	rs422_frame.data_stream.gyroX = (short)result->heading/Rate_Scale*Sensor_Scale;
	rs422_frame.data_stream.gyroY = (short)result->heading/Rate_Scale*Sensor_Scale;
	rs422_frame.data_stream.gyroZ = (short)result->heading/Rate_Scale*Sensor_Scale;
	
	rs422_frame.data_stream.accelX = (short)result->heading/Accel_Scale*Sensor_Scale;
	rs422_frame.data_stream.accelY = (short)result->heading/Accel_Scale*Sensor_Scale;
	rs422_frame.data_stream.accelZ = (short)result->heading/Accel_Scale*Sensor_Scale;
	
	rs422_frame.data_stream.latitude = (long)(result->latitude * 100000.0);
	rs422_frame.data_stream.longitude = (long)(result->longitude * 100000.0);
	rs422_frame.data_stream.altitude = (long)(result->altitude * 1000.0);
