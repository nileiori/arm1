...
{
    uint16_t datalen;
    datalen = gd32_usart_read(usart_rx_data.usart_rx_buffer, 0);

    if(datalen)
    {
        frameParse(usart_rx_data.usart_rx_buffer, datalen);
        //gd32_usart_write(usart_rx_data.usart_rx_buffer, datalen);
    }
}
