...
#define RYM_WAIT_CHR_TICK (INS_TICK_PER_SECOND * 3)
#endif
/* how many ticks wait for between packet. */
#ifndef RYM_WAIT_PKG_TICK
#define RYM_WAIT_PKG_TICK (INS_TICK_PER_SECOND * 3)
#endif
/* how many ticks between two handshake code. */
#ifndef RYM_CHD_INTV_TICK
#define RYM_CHD_INTV_TICK (INS_TICK_PER_SECOND * 3)
#endif
 ...
 */
typedef enum rym_code (*rym_callback)(struct rym_ctx *ctx, ins_uint8_t *buf, ins_size_t len);
 ...
 * second.
 */
ins_err_t rym_recv_on_device(struct rym_ctx *ctx,
